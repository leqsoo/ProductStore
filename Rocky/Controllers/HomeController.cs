...
namespace Rocky.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                Product = _productRepository.FirstOrDefault(p => p.Id == id, includeProperties: "Category,ApplicationType"),
                ExistsInCart = false,
            };
        ...
        public IActionResult RemoveFromCart(int id)
        {
            ...
            var itemToRemove = shoppingCartList.FirstOrDefault(p => p.ProductId == id);
